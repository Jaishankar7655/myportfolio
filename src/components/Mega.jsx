  ...
  const projects = [
    {
      ...
      description: "A comprehensive platform with fully integrated frontend, backend, and database. Features include OTP-based registration, validation, user authentication, and a seamless payment system.",
    ...
    },
    {
      ...
      description: "A real-time data platform built with frontend and backend REST API integration, providing detailed information about countries worldwide.",
              ...
              >
                <div className="md:flex">
                  ...
                  <div className="md:w-2/3 p-6">
                    ...
                    {/* Technologies Used */}
                    <div className="mb-4">
                      <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Technologies Used:</h3>
                    ...
                    {project.images && project.images.length > 1 && (
                      <div className="mt-4">
                        <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Additional Images:</h3>
